...
define(function(require,exports,module){
	...
	Util.prototype.serviceTypeMap=function(type){
		var map={
			...
			'0001000300030003':'保姆',
			'0001000300020003':'油烟机（中式）',
			'0001000300020004':'油烟机（欧式）',
			'0001000300020005':'油烟机（侧吸式）'
		}
		return map[type];
	}
	...
	Util.prototype.serviceTypeMapReverse=function(type){
		var map={
			...
			'油烟机（中式）':'0001000300020003:fotile',
			'油烟机（欧式）':'0001000300020004:fotile',
			'油烟机（侧吸式）':'0001000300020005:fotile'
		}
		return map[type];
	}
