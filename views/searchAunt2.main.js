define(function(require,exports,module){
    ...
    function _init(){
		...
		$('.component').height($(window).height()-$('header').height());
	...
	function createNotes() {
		...
		for(var i = 0; i < totalNotes; ++i) {
			...
			notesElContent += '<img class="note icon aunt-icon" src="img/user_icon.jpg"/>';
		}
	...
	function showAuntList(){
		window.location.href='auntList.html';
	}
	/**
